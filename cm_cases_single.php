...
<div id = "single_menu">
<a class="singlenav"  style="text-decoration:none;color:#d2d2d2;font-weight:bold;" id="one_href" href="#" onClick="createTargets('case_activity','case_activity');sendDataGetAndStripe2('cm_case_activity.php?id=$id&ieyousuck=' + Math.random()*5);changeTab('one_href');return false;">Case Activity</a> | <a class="singlenav"  id="two_href" href="#" onClick="createTargets('case_activity','case_activity');sendDataGet('cm_docs.php?id=$id&ieyousuck=' + Math.random()*5);changeTab('two_href');return false;">Documents</a> | <a class="singlenav"  id="three_href"  href="#" onClick="createTargets('case_activity','case_activity');sendDataGet('cm_cases_events.php?id=$id');changeTab('three_href');return false;">Events</a>  | <a class="singlenav"  id="four_href"  href="#" onClick="createTargets('case_activity','case_activity');sendDataGet('message_roll.php?case_id=$id');changeTab('four_href');return false;">Messages</a> | <a  class="singlenav" id="five_href" href="#" onClick="createTargets('case_activity','case_activity');sendDataGet('cm_case_contacts.php?id=$id&ieyousuck=' + Math.random()*5);changeTab('five_href');return false;">Case Contacts</a> | <a class="singlenav"  id="six_href"  href="#" onClick="createTargets('case_activity','case_activity');sendDataGet('client_data.php?id=$id&ieyoursuck=' + Math.random()*5);changeTab('six_href');return false;">Client Data</a>
DISPLAY;
...
<span id="close"><a alt="Print this data" title="Print this Data" href="#" onClick="printDivComplex('case_activity');return false;"><img src="images/print_small.png" border="0" style="margin-right:30px;"></a><a href="#" onclick="Effect.Shrink('window1');document.getElementById('view_chooser').style.display = 'inline';return false;" alt="Close this Case Window" title="Close this Case Window"><img src="images/cancel_small.png" border="0"></a></span>
DISPLAY;
