...
--
-- Host: localhost
-- Generation Time: May 13, 2008 at 11:54 AM
...
CREATE TABLE `cm` (
  ...
  `phone3` varchar(15) NOT NULL default '',
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COMMENT='used to check for conflicts' AUTO_INCREMENT=40 ;
...
CREATE TABLE `cm_cases_students` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COMMENT='Determine which students assigned to a case' AUTO_INCREMENT=242 ;
...
CREATE TABLE `cm_case_notes` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8908 ;
...
CREATE TABLE `cm_documents` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2881 ;
...
CREATE TABLE `cm_events_responsibles` (
  ...
  `last_name` varchar(100) NOT NULL default '',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COMMENT='Linked to cm_events; who is responsible for each event' AUTO_INCREMENT=1054 ;
...
CREATE TABLE `cm_journals` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8394 ;
...
CREATE TABLE `cm_logs` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8005 ;
...
CREATE TABLE `cm_messages` (
  ...
  `read` varchar(100) NOT NULL default '',
  `archive` varchar(100) NOT NULL default '',
  `temp_id` varchar(100) NOT NULL default '',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4165 ;
