...
</td><td><textarea cols="20" rows="2" id="description" name="description"></textarea></td><td>

<a href="#" onClick="var check = forceDate('date$date');if (check == true){createTargets('status','the_info');sendDataPostAndStripeNoStatus2('add_time.php','time_form');clearForm();updateLeftSide($id); return false;}" alt="Add This Case Note" title="Add This Case Note"><img src="images/check_yellow.png" border="0"></a></td><td><a title="Cancel Edit" alt="Cancel Edit" href="#" onClick="Effect.BlindUp('time_form');return false;"><img src="images/cancel_small.png" border="0"></a></td></tr></table></form>
