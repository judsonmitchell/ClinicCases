...
if ($count < 1) {
	...
	if ($error[1]) {
		...
		$resp = array('error' => false, 'message' => "The user's password has been reset to <b>$gen_pass</b>", 'html' => "<div id='dialogText'>The user's password has been reset to </div><div id='copy'><p id='copyText'><b>$gen_pass</b></p><button id='copyButton'><img src='html/ico/copy.png' alt='' /></button></div>");
