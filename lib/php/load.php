<?php
	...
	function load($page)

		{
			...
			$allowed_includes = array('Login.php','Home.php','Cases.php','Case.php','Group.php','Journals.php','Board.php','Users.php','Utilities.php','Prefs.php', 'Messages.php', 'New_Pass.php','QuickAdd.php');
