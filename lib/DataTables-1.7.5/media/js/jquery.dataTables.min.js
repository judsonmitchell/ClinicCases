...
sLengthMenu:"Show _MENU_ entries",sZeroRecords:"No matching cases found",sEmptyTable:"No data available in table",sInfo:"Showing _START_ to _END_ of _TOTAL_ cases",sInfoEmpty:"Showing 0 to 0 of 0 cases",sInfoFiltered:"(filtered from _MAX_ total cases)",sInfoPostFix:"",sSearch:"Search:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.iNextId=0;this.asDataSearch=
