...
$(document).ready(function() {
    ...
    $('#show_preferences').click(function(event) {
        ...
        ' | <a href="#" class="toggle">Change Picture</a> |' +
        ...
        $(prefForm).dialog({
            ...
            open: function()
            {
                ...
                //Profile view
                $('div#pref_nav a').eq(0).click(function() {
                ...
                //Password view
                $('div#pref_nav a').eq(1).click(function() {
                ...
                //Picture view
                $('div#pref_nav a').eq(2).click(function() {

                    $('div#pref_nav a').removeClass('active');
                    $(this).addClass('active');
                    $('#pref_body').load('lib/php/users/preferences_load.php div.pref_change_picture', function() {
                        $(this).children().show();
                    });
                });

                //Private key view
                $('div#pref_nav a').eq(3).click(function() {
                ...
                $('button.change_private_key_form_submit').live('click', function(event) {
                    ...
                    $.post('lib/php/users/preferences_process', ({'action': 'change_private_key','id': userId}), function(data) {
                        var serverResponse = $.parseJSON(data);
                        if (serverResponse.error === true)
                        {
...
window.onerror = function(error, url, line) {
    ...
    $.post('lib/php/utilities/bug_reporter.php', {'key': key,'type': 'errorLog','url': url,'browser': browser,'error': errorString});
