...
export const getUserChooserList = (case_id, value, type) => {
  return axios
    .post('lib/php/data/cases_load_users_for_chooser.php', { case_id, value, type })
    .then((res) => res.data);
};
export const getMessagesUserChooserList = (case_id, value, type) => {
  return axios
    .post('lib/php/users/cases_messages_user_chooser_load.php', { case_id, value, type })
    .then((res) => res.data);
};
...
export const getCaseContactsData = async (case_id) => {
  return axios
    .post(`lib/php/data/cases_contacts_load.php`, { case_id})
    .then((res) => res.data);
};