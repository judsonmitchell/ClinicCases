...
<div id="contacts_menu"><a href="#" class="singlenav" onClick="Effect.BlindDown('add_contact');return false;">Add Contact</a> 
...
<div id = "contact_list" style="padding-left:5px;padding-top:5px;overflow:auto;">
MENU;
if ($_POST[edit])
{
echo <<<NOTIFIER
