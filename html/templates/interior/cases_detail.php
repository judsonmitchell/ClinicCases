<div class = "case_detail_bar">
	...
	<div class="assigned_people">
		...
		<?php if ($assigned_users_data){ foreach ($assigned_users_data as $user)
		{
			...
			{
			echo "<li class = 'active'><span><img tabindex='1' id='imgid_" . $user['case_id'] . "_" . $user['username']  . "' src='$thumbnail' title='" . $user['first_name'] . " " . $user['last_name'] . "'></span></li>";
			}

			else

			{
			echo "<li class = 'inactive'><span><img tabindex='1' id='imgid_" . $user['case_id'] . "_" . $user['username']  . "' src='$thumbnail' title='" . $user['first_name'] . " " . $user['last_name'] . "'></span></li>";
			}
