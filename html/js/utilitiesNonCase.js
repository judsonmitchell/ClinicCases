...
function loadCaseNotes(panelTarget, id) {
    ...
    function () {
        ...
        $('div.case_detail_panel_tools').css({'height': '10%'});
        $('div.case_detail_panel_casenotes').css({'height': '80%'});
...
function addMoreNotes(scrollTarget) {
    ...
    if (scrollPercent > 70)
    {
        ...
        $.post('lib/php/data/cases_casenotes_load.php', {'case_id': caseId,'start': scrollTarget.data('start'), 'non_case': '1', 'update': 'yes'}, function(data) {
