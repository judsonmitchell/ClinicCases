...
$(document).ready(function() {
    ...
    $('#config_button').click(function() {
		target.load('lib/php/data/utilities_configuration_load.php',function(){

			$('div.config_item > a').live('click',function(event){
			...
			$('a.change_config').live('click',function(event){
				...
				var formParent = formTarget.parent();
				...
				$.post('lib/php/data/utilities_configuration_process.php',formVals,function(data){
                    ...
                    if (serverResponse.error === true)
                        ...
                        else
                        {
                            ...
                            formParent.load('lib/php/data/utilities_configuration_load.php form[name="' + formTarget.attr('name') +'"]');
                        }
