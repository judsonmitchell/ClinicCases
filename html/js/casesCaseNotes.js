...
//   var scrollPercent =
//     (scrollAmount / (scrollHeight - scrollTarget.height())) * 100;
...
//   var cseNoteParentMaxHeight = $(this)
//     .closest('.csenote')
//     .data('maxCaseNoteHeight');
//   var cseNoteParentMinHeight = $(this)
//     .closest('.csenote')
//     .data('minCaseNoteHeight');
...
//   $('input.csenote_date_value').datepicker({
//     dateFormat: 'm/d/yy',
//     showOn: 'button',
//     buttonText: thisDate,
...
//       .siblings('div.case_detail_panel_casenotes'),
//     'Casenotes: ' +
//       $(this)
//         .closest('.case_detail_panel')
//         .siblings('.case_detail_bar')
...
//           resultTarget.load(
//             'lib/php/data/cases_casenotes_load.php',
//             { case_id: thisCaseNumber, start: '0', update: 'yes' },
//             function () {
//               sizeCaseNotes($('.csenote'), resultTarget);
//             },
//           );
...
//         $.post(
//           'lib/php/data/cases_casenotes_process.php',
//           { query_type: 'delete', csenote_casenote_id: thisCseNoteId[1] },
//           function (data) {
//             var serverResponse = $.parseJSON(data);
//             if (serverResponse.error === true) {
//               notify(serverResponse.message, true);
...
//   if (
//     $(this).closest('.case_detail_panel_casenotes').find('.csenote_edit_submit')
//       .length
//   ) {
...
//   var txtVal = escapeHtml(
//     thisCseNote.find('p.csenote_instance').html().br2nl(),
//   );
...
//   editNote
//     .find('button.csenote_action_submit')
//     .html('Done')
//     .addClass('csenote_edit_submit')
//     .removeClass('csenote_action_submit');
//   editNote
//     .find('input.csenote_date_value')
//     .val(dateVal)
//     .datepicker({
//       dateFormat: 'm/d/yy',
//       showOn: 'button',
...
//     .find('form')
//     .append(
//       '<input type="hidden" name="csenote_casenote_id" value="' +
//         cseNoteId[1] +
//         '">',
//     );
//   editNote
//     .find('button.csenote_action_cancel')
//     .unbind()
//     .bind('click', function () {
//       editNote.remove();
//       thisCseNote.show();
...
//               thisCseNote
//                 .find('.csenote_time')
//                 .html(cseVals[2]['value'] + ' minutes');
//             } else {
//               thisCseNote
//                 .find('.csenote_time')
//                 .html(
//                   cseVals[1]['value'] + '.' + cseVals[2]['value'] + ' hours',
//                 );
//             }
...
//   e.preventDefault();
//   elPrint(
//     $(this).closest('div.csenote'),
//     $(this).closest('.ui-tabs-panel').find('.case_title').text() + ' case',
//   );
// });
...
//   var panelTarget = $(this).closest('.ui-tabs-panel');
//   var id = $(this)
//     .closest('.case_detail_nav')
//     .siblings('.case_detail_panel')
//     .data('CaseNumber');
//   loadCaseNotes(panelTarget, id);
// });

function live(eventType, className, cb) {
