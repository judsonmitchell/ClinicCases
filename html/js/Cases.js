...
//   var opField =
//     opFieldRaw.substring(6, 10) +
//     opFieldRaw.substring(0, 2) +
//     opFieldRaw.substring(3, 5);
//   var opField2 =
//     opFieldRaw2.substring(6, 10) +
//     opFieldRaw2.substring(0, 2) +
//     opFieldRaw2.substring(3, 5);
//   var clField =
//     clFieldRaw.substring(6, 10) +
//     clFieldRaw.substring(0, 2) +
//     clFieldRaw.substring(3, 5);
//   var clField2 =
//     clFieldRaw2.substring(6, 10) +
//     clFieldRaw2.substring(0, 2) +
//     clFieldRaw2.substring(3, 5);
//   var opRow =
//     opRowRaw.substring(6, 10) +
//     opRowRaw.substring(0, 2) +
//     opRowRaw.substring(3, 5);
//   var clRow =
//     clRowRaw.substring(6, 10) +
//     clRowRaw.substring(0, 2) +
//     clRowRaw.substring(3, 5);
