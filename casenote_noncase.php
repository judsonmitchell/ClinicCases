...
?>
 ...
 <table width="95%" align=center border=0><tr><td width=50%><span class="name">Non-Case Time</span></td><td align="left" width=50%><a href="#" onClick="Effect.BlindDown('time_form');return false;">Add</a></td></tr></table>
...
<a href="#" onClick="var check = forceDate('date<?php echo $date; ?>');if (check == true){createTargets('status','the_info');sendDataPostAndStripeNoStatus2('add_time.php','time_form');clearForm();return false;}" alt="Add This Case Note" title="Add This Case Note"><img src="images/check_yellow.png" border="0"></a></td><td><a title="Cancel Edit" alt="Cancel Edit" href="#" onClick="Effect.BlindUp('time_form');return false;"><img src="images/cancel_small.png" border="0"></a></td></tr></table></form></div>
