...
{
echo <<<CLEAR
<tr><td colspan="8"><div id="clearer" style="width:100%;height:20px;background-color:#C3D9FF;text-align:center;"><a class="nobubble" href="cm_admin_users.php">Clear Search Results</a></div></td></tr>
CLEAR;
...
<td ><a class="nobubble" href="#" onClick="createTargets('deac$d[id]','deac$d[id]');sendDataGet('user_change_status.php?id=$d[id]');return false;" title="Click this to either activate an inactive user or inactivate an active user" alt="Click this to either activate an inactive user or inactivate an active user">Change Status</a></td></td></tr>
ROWS;
