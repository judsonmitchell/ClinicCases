...
<form style="display:inline;" onSubmit="createTargets('work_space','work_space');sendDataGetAndStripe('cm_admin_users_table.php?searchterm=' + document.getElementById('search').value);return false;"><input type = "text" width="35" value="Search By Name" id = "search" name = "search" onFocus = "this.value = '';this.style.color= 'black';" style="display:inline;">
<a href="#" onClick="createTargets('work_space','work_space');sendDataGetAndStripe('cm_admin_users_table.php?searchterm=' + document.getElementById('search').value);document.getElementById('choose_port').style.display = 'none';return false;"><img src="./images/check.png" border="0"  class = "submit_image"></a></form>
...
<td ><a href="#" onClick="createTargets('deac$d[id]','deac$d[id]');sendDataGet('user_change_status.php?id=$d[id]');return false;" title="Click this to either activate an inactive user or inactivate an active user" alt="Click this to either activate an inactive user or inactivate an active user">Change Status</a></td></tr>
ROWS;
