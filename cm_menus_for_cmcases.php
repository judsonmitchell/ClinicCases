...
</script><div id="menus"><a class="menu" href="#"  onClick="Effect.Appear('bug');createTargets('bug','bug');sendDataGet('bugs_report.php');return false;">Report Problems</a> | <a class="menu" href="#" onClick="stopTimer('logout.php');">Logout</a> | Status: <span id="session_info"><span style="color:red;">Offline</span></span></div>  
